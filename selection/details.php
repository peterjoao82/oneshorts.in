<section id="knowl">
        <div class="info">
            <h4>VTU Calculator | Calculate VTU SGPA & CGPA Online</h4>
            <p>
    ...
    <section id="knowl">
        <div class="info">
            ...
            <p>
                ...
                VTU CGPA Calculator is to make your VTU marks and grades calculation easier. <br />This is a free on-line tool to assist the VTU (Visveswaraiah Technological University) students. <br />We all know that calculating CGPA is easy, however the general public don’t wish to pay a lot of time on manual arithmetic as a result of the provision of on-line tools. <br />Here, we'll show you the way to calculate your CGPA faster:
            </p>

            <h4>Open the VTU CGPA Calculator.</h4>
            <p>
                Enter your Total Marks for semesters one to eight. <br />Leave the fields blank, if any semesters aren't completed.<br />
            ...
            <p>See <a href="https://vtu.ac.in/" target="_blank">VTU official web site</a> for additional information.</p>
            ...
            <p><li><a href="https://results.vtu.ac.in/" target="_blank">Check lastest VTU results.</a></li></p>
        </div>
    </section>