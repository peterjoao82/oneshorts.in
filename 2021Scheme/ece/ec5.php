...
<section id="designn">
        <div class="design">
            ...
            <div class="row_main">
                <div class="row">
                    <div class="design1">
                        <label class="color">21EC51 :</label>
                        <input type="number" placeholder="[0 - 100]" id="ME3_1">
                    </div>
                    <div class="design1">
                        <label class="color">21EC52 :</label>
                        <input type="number" placeholder="[0 - 100]" id="ME3_2">
                    </div>
                    <div class="design1">
                        <label class="color">21EC53 :</label>
                        <input type="number" placeholder="[0 - 100]" id="ME3_3">
                    </div>
                    <div class="design1">
                        <label class="color">21EC54 :</label>
                        <input type="number" placeholder="[0 - 100]" id="ME3_4">
                    </div>
                    <div class="design1">
                        <label class="color">21ECL55 :</label>
                        <input type="number" placeholder="[0 - 100]" id="ME3_5">
                    </div>
                </div>
                <div class="row">
                    <div class="design1">
                        <label class="color">21EC56 :</label>
                    ...
                    <div class="design1">
                        <label class="color">21EC58X :</label>
