...
<section id="designn">
        <div class="design">
            ...
            <div class="row_main">
                <div class="row">
                    <div class="design1">
                        <label class="color">21EC71 :</label>
                        <input type="number" placeholder="[0 - 100]" id="ME3_1">
                    </div>
                    <div class="design1">
                        <label class="color">21EC72 :</label>
                    ...
                    <div class="design1">
                        <label class="color">21EC73* :</label>
                        <input type="number" placeholder="[0 - 100]" id="ME3_4">
                    </div>
                    <div class="design1">
                        <label class="color">21EC74* :</label>
                        <input type="number" placeholder="[0 - 100]" id="ME3_5">
                    </div>
                    <div class="design1">
                        <label class="color">21ECP75 :</label>
