        ...
        <div class="design">
            ...
            <div class="row_main">
                <div class="row">
                    ...
                    <div class="design1">
                        <label class="color">21CS62 :</label>
                        <input type="number" placeholder="[0 - 100]" id="ME3_2">
                    </div>
                    <div class="design1">
                        <label class="color">21CS63 :</label>
                ...
                <div class="row">
                    <div class="design1">
                        <label class="color">21CSL66 :</label>
                        <input type="number" placeholder="[0 - 100]" id="ME3_6">
                    </div>
                    <div class="design1">
                        <label class="color">21CSMP67 :</label>
