...
<section id="designn">
        <div class="design">
            ...
            <div class="row_main">
                <div class="row">
                    <div class="design1">
                        <label class="color">21CS51 :</label>
                        <input type="number" placeholder="[0 - 100]" id="ME3_1">
                    </div>
                    <div class="design1">
                        <label class="color">21CS52 :</label>
                        <input type="number" placeholder="[0 - 100]" id="ME3_2">
                    </div>
                    <div class="design1">
                        <label class="color">21CS53 :</label>
                        <input type="number" placeholder="[0 - 100]" id="ME3_3">
                    </div>
                    <div class="design1">
                        <label class="color">21CS54 :</label>
                        <input type="number" placeholder="[0 - 100]" id="ME3_4">
                    </div>
                    <div class="design1">
                        <label class="color">21CSL55 :</label>
                        <input type="number" placeholder="[0 - 100]" id="ME3_5">
                    </div>
                </div>
                <div class="row">
                    <div class="design1">
                        <label class="color">21XX56 :</label>
                        <input type="number" placeholder="[0 - 100]" id="ME3_6">
                    </div>
                    <div class="design1">
                        <label class="color">21CIV57 :</label>
                        <input type="number" placeholder="[0 - 100]" name="" id="ME3_7">
                    </div>

                    <div class="design1">
                        <label class="color">21CS58X :</label>
